        ...
        <form action="{{ url('admin/article/'.$field->art_id) }}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    <th>编辑：</th>
                    <td>
                        <input type="text" class="lg" name="art_order" value="{{ $field->art_order }}">
                    </td>
                </tr>
                <tr>
                    <th>缩略图：</th>
                ...
                <tr>
                    ...
                    <td>
                        <script name="art_content" id="editor" type="text/plain" style="width:1024px;height:500px;">{!! $field->art_content !!}</script>
                    </td>
                </tr>
                <tr>
                    <th></th>
